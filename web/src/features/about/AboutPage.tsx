  ...
  return <div className="site-layout about-page" dir="rtl">
    ...
    <div className="site-content">
      <main>
        ...
        <section className="contact-strip" id="contact"><div><strong>هل لديك سؤال أو تريد التواصل مع الفريق؟</strong><span>نحن نتواصل عبر تيليغرام وبريد المشروع</span></div><a className="contact-button" href="mailto:hello@mosqueshelves.org"><LineIcon name="send" />تواصل مع الفريق</a></section>
